...
filePathForGTF="${dirPathWithResults}/mergeOverlapGenesOfFilteredTranscriptsOfMus_musculus.GRCm38.102_ExonsCDSOnly_UCSC_Refseq.gtf"
...
sample="mm10_custom102_allGastruloids_min10"
